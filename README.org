...
|        5 | =init-editing.el=     | Multiple-cursors                                      | —      |
...
Other completed modules not on original roadmap: =init-recentf.el=, =init-dired.el=, =init-web.el=, =init-highlight-symbol.el=, =init-rainbow-delimiters.el=, =init-hydra.el=, =init-ace-window.el=, =init-mwim.el=, =init-undo-tree.el=, =init-treemacs.el=, =init-git.el=.
