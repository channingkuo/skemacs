...
| Key       | Function           | Description        |
|-----------+--------------------+--------------------|
| =C-x b b= | =switch-to-buffer=  | Switch buffer      |
...
| Priority | Module File           | Feature                             |
|----------+-----------------------+-------------------------------------|
|        1 | =init-theme.el=       | Theme setup                         |
|        2 | =init-which-key.el=   | Key discovery (useful for all)      |
|        3 | =init-completion.el=  | Ivy / Counsel / Swiper              |
...
3. =M-x describe-personal-keybindings= — View all =:bind= custom bindings
