...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-startup-banner 112
...
before packages are loaded."
  ...
  (with-eval-after-load 'evil
    ...
    (define-key evil-visual-state-map (kbd "J") 'move-down-10-lines))
  ...
  (with-eval-after-load 'evil
    ...
    (define-key evil-visual-state-map (kbd "K") 'move-up-10-lines))
  ...
  (with-eval-after-load 'origami
    (spacemacs/set-leader-keys
      ...
      "z r" 'origami-open-node-recursively
